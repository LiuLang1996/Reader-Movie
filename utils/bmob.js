...
(function(root) {
  ...
  Bmob._request = function(route, className, objectId, method, dataObject) {
    ...
    if (
      (route === "users" || route === "classes") &&
      method === "PUT" &&
      dataObject._fetchWhenSave
    ) {
      ...
      _mergeWithPrevious: function(previous) {
        if (!previous) {
          ...
          if (
            ...
            throw "Related object must be of class " +
              previous._targetClassName +
              ", but " +
    ...
    **/
    ...
    destroy: function(options) {
      if (!this._url && !this._cdn)
        return Bmob.Promise
          .error("The file url and cdn is not eixsts.")
    ...
    save: function(options) {
      ...
      if (!self._previousSave) {
        if (self._source) {
          self._previousSave = self._source
            .then(function(base64, type) {
              var data = {
                base64: base64,
  ...
  _.extend(
    ...
    /** @lends Bmob.Object.prototype */
    {
      ...
      toJSON: function() {
        ...
        Bmob._arrayEach(["__type", "className"], function(key) {
          delete json[key];
        });
        return json;
      },
      ...
      save: function(arg1, arg2, arg3) {
        ...
        var unsavedChildren = [];
        var unsavedFiles = [];
        Bmob.Object._findUnsavedChildren(
          model.attributes,
          unsavedChildren,
          unsavedFiles
        );
        if (unsavedChildren.length + unsavedFiles.length > 0) {
          return Bmob.Object._deepSaveAsync(this.attributes).then(
            function() {
  ...
  Bmob.Object.destroyAll = function(objects, options) {
    ...
    var data = _.map(objects, function(object) {
    ...
    var request = Bmob._request("batch", null, null, "POST", {
      requests: data
    });
    return request._thenRunCallbacks(options);
  };
  ...
  Bmob.Object._deepSaveAsync = function(object) {
    ...
    return promise
      .then(function() {
        return Bmob.Promise._continueWhile(
          function() {
          ...
          function() {
            ...
            var readyToStart = Bmob.Promise.when(
  ...
  Bmob.User = Bmob.Object.extend(
      ...
      loginWithWeapp: function(code) {
        ...
        Bmob.User.requestOpenId(code, {
          success: function(authData) {
            ...
            user._linkWith(platform, authData).then(
              function(resp) {
    ...
    /** @lends Bmob.User */
    {
      ...
      current: function() {
        ...
        var userData = false;
        try {
          var userData = wx.getStorageSync(
    ...
    get: function(objectId, options) {
      ...
      return self
        ...
        .then(function(response) {
          ...
          var errorObject = new Bmob.Error(
